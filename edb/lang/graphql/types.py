...
# These are shortcuts that can be used for shadow_fields to indicate
# whether all fields are expected to be used in translation as is or
# none of them. Otherwise shadow_fields is a white-list containing the
# field names that are translated directly into EdgeQL. This means
# that the operator "in" is typically used with shadow_fields.
